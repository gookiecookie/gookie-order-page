...
function renderPaymentStep() {
  ...
  /*
   * The real Order ID is generated by Apps Script only
   * after the customer confirms payment and continues
   * to WhatsApp.
   */
  paymentOrderId.textContent = "Generated after payment";

  paymentTotal.textContent =
    formatMoney(getOrderTotal());
